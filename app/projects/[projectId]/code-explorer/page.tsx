  ...
  return (
    <PageContainer scrollable>
      <div className="flex gap-4 p-4">
        {/* File Explorer Card */}
        <div className="flex-shrink-0 p-4 bg-white dark:bg-black rounded-lg shadow-lg md:w-1/6 w-full">
          <h2 className="text-lg md:text-xl font-semibold mb-4">File Explorer</h2>
          <TreeView data={files} onFileClick={handleFileClick} />
        </div>

        {/* Code Editor Card */}
        <div className="flex-1 p-4 bg-white dark:bg-black rounded-lg shadow-lg md:w-1/2 w-full">
